...
import { createVaccinationCentre } from "../../store/actions";

const CreateVaccinationCentre = ({ isOpen, handleClose }) => {
  ...
  const { isCreatingVaccinationCentre } = useSelector(
  ...
  const handleCreate = (e) => {
    ...
    dispatch(createVaccinationCentre(userData, handleClose));
  };
      ...
      <FormWrapper onSubmit={checkValidity}>
        <Grid container spacing={2}>
          <Grid item sm={12} xs={12}>
            <Heading title={"Create Vaccination Center"} />
          </Grid>
          <Grid item sm={12} xs={12}>
            <TextField
              required
        ...
        <FormActionButton
          ...
          loading={isCreatingVaccinationCentre}
        />
      </FormWrapper>
    </CustomModal>
  );
