...
const VaccinationAppointmentsReport = () => {
      ...
      >
        <SpaceBetween>
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              Report | CORONA VIRUS DISEASE (COVID-19) Vaccination Appointments
            </Typography>
            {state?.otherData?.center && (
              <Typography fontSize="15px" sx={{ marginBottom: 1 }}>
                <b>Vaccination Center:</b> {state?.otherData?.center}
              </Typography>
            )}
...
export default VaccinationAppointmentsReport;
