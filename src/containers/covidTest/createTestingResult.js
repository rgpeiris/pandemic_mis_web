...
import { createPandemicTestResult } from "../../store/actions";

const CreateTestingResult = ({ isOpen, handleClose }) => {
  ...
  const handleCreate = (e) => {
    ...
    dispatch(createPandemicTestResult(userData, handleClose));
  };
  ...
  return (
    <CustomModal isOpen={isOpen} handleClose={handleClose}>
      {isGettingTestings || isGettingTestCentres ? (
        <Loading />
      ) : (
        <FormWrapper onSubmit={checkValidity}>
          <Grid container spacing={2}>
            <Grid item sm={12} xs={12}>
              <Heading title={"Create Testing Result"} />
            </Grid>
            <Grid item sm={12} xs={12}>
              <TextField
                required
          ...
          <FormActionButton
            ...
            loading={isCreatingPandemicTestResult}
          />
        </FormWrapper>
      )}
    </CustomModal>
...
export default CreateTestingResult;
